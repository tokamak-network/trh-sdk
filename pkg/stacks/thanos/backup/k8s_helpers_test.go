...
// newBackupClient returns a BackupClient backed by the given mock runner.
func newBackupClient(kr *mock.K8sRunner) *BackupClient {
	return NewBackupClient(kr)
}
...
func TestSetDefaultK8sRunner_UpdatesDefaultClient(t *testing.T) {
	...
	if defaultClient.k8sRunner == nil {
