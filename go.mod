...
require (
	...
	github.com/tokamak-network/tokamak-thanos v0.0.0-20250102090606-a67ef0b20576
...
replace github.com/consensys/gnark-crypto => github.com/consensys/gnark-crypto v0.10.0
